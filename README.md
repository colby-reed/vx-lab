...
leaf03   - vlan 10 - 10.1.10.1/10.1.10.2 - vrf RED
         - vlan 20 - 10.1.20.1/10.1.20.2 - vrf RED
         - vlan 30 - 10.1.30.1/10.1.30.2 - vrf BLUE
leaf04   - vlan 10 - 10.1.10.1/10.1.10.3 - vrf RED
         - vlan 20 - 10.1.20.1/10.1.20.3 - vrf RED
         - vlan 30 - 10.1.30.1/10.1.30.3 - vrf BLUE
...
Clone the repo
```
git clone --recurse-submodules https://gitlab.com/cumulus-consulting/goldenturtle/dc_configs_vxlan_evpnsym.git && cd dc_configs_vxlan_evpnsym/automation/
```
